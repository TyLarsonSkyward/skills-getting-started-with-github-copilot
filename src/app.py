...
activities = {
    ...
    "Basketball Team": {
        "description": "Join the competitive basketball team and participate in games and tournaments",
    ...
    "Science Club": {
        ...
        "max_participants": 18,
        "participants": ["mia@mergington.edu", "ethan@mergington.edu", "isabella@mergington.edu"]
    }
}
